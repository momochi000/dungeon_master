...
** TODO update the graph according to entities and relationships in json
...
** TODO continue fleshing out fixture, use game chat from gpt
** TODO create initial character sheet data structure
