...
CLOSED: [2024-03-30 Sat 19:27]
*** TODO fix usages of get-embedding
...
*** TODO Test that i can query for a vector using a label other than KnowlegeObject
...
*** TODO return vector results along with their similarity scores
*** TODO cut off vector search results under some threshold.
i need to get the value of the similarity result as well
